...
!function (t, i, e) {
    function s(e, s) {
        ...
        for (var o in s) 
            this.options[o] = s[o];
        this.translateZ = this.options.HWCompositing && h.hasPerspective
            ? " translateZ(0)"
            : "",
        ...
        this.options.useTransition || this.options.useTransform || /relative|absolute/i.test(
    ...
    function n(e, s) {
        this.wrapper = "string" == typeof s.el
        ...
        if (
            ...
            if (!n) 
                return;
            this.wrapperStyle[n] = h.isBadAndroid
                ? "0.0001ms"
                : "0ms";
            var a = this;
    ...
    var r = t.requestAnimationFrame || t.webkitRequestAnimationFrame || t.mozRequestAnimationFrame || t.oRequestAnimationFrame || t.msRequestAnimationFrame || function (
            i
        ) {
        ...
        h = function () {
            ...
            return o.extend(o, {
                hasTransform: h !== !1,
                hasPerspective: s("perspective") in n, hasTouch: "ontouchstart" in t, hasPointer: !(
                ...
                elastic: {
                    ...
                    fn: function (t) {
                        ...
                        return 0 === t
                            ...
                            : 1 == t
                                ? 1
                                : s * e.pow(2, -10 * t) * e.sin((t - i / 4) * (2 * e.PI) / i) + 1
                    }
                }
            }),
            o.tap = function (t, e) {
    ...
    s.prototype = {
        ...
        _transitionEnd: function (t) {
            t.target == this.scroller && this.isInTransition && (
        ...
        _start: function (t) {
            ...
            if (this.enabled && (!this.initiated || h.eventType[t.type] === this.initiated)) {
                !this.options.preventDefault || h.isBadAndroid || h.preventDefaultException(
                    t.target,
        ...
        _end: function (t) {
            if (this.enabled && h.eventType[t.type] === this.initiated) {
                this.options.preventDefault && !h.preventDefaultException(
                    t.target,
                    this.options.preventDefaultException
                ) && t.preventDefault();
                var i,
                ...
                if (
                    ...
                    if (this.options.momentum && o < 300 && (
                        ...
                        this.currentPage = d,
                        c = this.options.snapSpeed || e.max(
        ...
        resetPosition: function (t) {
            ...
            (i != this.x || e != this.y) && (
                this.scrollTo(i, e, t, this.options.bounceEasing),
                !0
            )
        },
        disable: function () {
        ...
        scrollTo: function (t, i, e, s) {
            ...
            !e || o
                ? (
                    o && (this._transitionTimingFunction(s.style), this._transitionTime(e)),
                    this._translate(t, i)
                )
        ...
        _translate: function (t, i) {
            if (
                this.options.useTransform
                    ? this.scrollerStyle[h.style.transform] = "translate(" + t + "px," + i + "px)" +
                                    this.translateZ
                    : (
                        t = e.round(t),
                        i = e.round(i),
        ...
        _initEvents: function (i) {
            ...
            h.hasPointer && !this.options.disablePointer && (
            ...
            h.hasTouch && !this.options.disableTouch && (
        ...
        _initSnap: function () {
            ...
            this.on("flick", function () {
                var t = this.options.snapSpeed || e.max(
                    e.max(e.min(e.abs(this.x - this.startX), 1e3), e.min(e.abs(this.y - this.startY), 1e3)),
                    300
                );
                this.goToPage(
        ...
        _nearestSnap: function (t, i) {
            ...
            for (
                ...
                i > 0
                    ? i = 0
                    : i < this.maxScrollY && (i = this.maxScrollY); s < o; s++
            ) 
        ...
        goToPage: function (t, i, s, o) {
            ...
            var n = this
                ...
                r = this
                    ...
                    .y;
            s = void 0 === s
                ? this.options.snapSpeed || e.max(
                    e.max(e.min(e.abs(n - this.x), 1e3), e.min(e.abs(r - this.y), 1e3)),
                    300
                )
                : s,
            this.currentPage = {
        ...
        _key: function (t) {
            if (this.enabled) {
                ...
                switch (
                    ...
                    this.keyAcceleration = r - a < 200
                        ? e.min(this.keyAcceleration + l, 50)
                        : 0,
                    t.keyCode
                ) {
    ...
    n.prototype = {
        ...
        _start: function (i) {
            ...
            this.options.disablePointer || h.addEvent(
                t,
            ...
            if (this.initiated) {
                if (
                    ...
                    var s = this
                        ...
                        o = this.options.snapSpeed || e.max(
                            e.max(e.min(e.abs(this.scroller.x - s.x), 1e3), e.min(e.abs(this.scroller.y - s.y), 1e3)),
                            300
                        );
                ...
                this.options.resize
                    ? (
                        this.indicatorWidth = e.max(
                            e.round(this.wrapperWidth * this.wrapperWidth / (this.scroller.scrollerWidth || this.wrapperWidth || 1)),
                            8
                        ),
                ...
                this.options.resize
                    ? (
                        this.indicatorHeight = e.max(
                            e.round(this.wrapperHeight * this.wrapperHeight / (this.scroller.scrollerHeight || this.wrapperHeight || 1)),
                            8
                        ),
        ...
        updatePosition: function () {
            ...
            this.options.ignoreBoundaries || (
                ...
                i < this.minBoundaryY
                    ? ("scale" == this.options.shrink && (this.height = e.max(
                        this.indicatorHeight + 3 * i,
                        8
                    ), this.indicatorStyle.height = this.height + "px"), i = this.minBoundaryY)
                    : i > this.maxBoundaryY
                        ? "scale" == this.options.shrink
                            ? (
            ...
            this.scroller.options.useTransform
                ? this.indicatorStyle[h.style.transform] = "translate(" + t + "px," + i + "px)" +
    ...
    e.fn.fp_scrolloverflow = function () {
                ...
                if (!i.hasClass("fp-noscroll")) {
                    ...
                    c.length
                        ...
                        : (
                            ...
                            a.options.verticalCentered && (s = i.find(g).get(0).scrollHeight - p)
                        );
                    var d = e(t).height() - p;
                    s > d
                        ? c.length
        ...
        var S = {
            ...
            init: function (i) {
                ...
                return S.iscrollOptions.click = o,
                S.iscrollOptions = e.extend(S.iscrollOptions, i.scrollOverflowOptions),
